set terminal qt font "Calibri,10"
#
...
set xtics font ",14" textcolor "black"
set ytics font ",14" textcolor "black"
set xzeroaxis ls 11
#
#set title "{/:Bold Short Period}" font ",20" norotate
set xlabel "t [s]" font ",14"
set ylabel "pitch rate [deg/s]" font ",14" offset 1.2
set label 1 "{/:Bold control to force oscillation}" font ",12" at 1.4, 0.85, 0.0 left norotate front
set label 2 "{/:Bold short period}\n{/:Bold oscillation area}" font ",12" at 1.75, 0.35, 0.0 left norotate front
set label 3 "{/:Bold short period}\n{/:Bold oscillation area}" font ",12" at 5.65, 0.35, 0.0 left norotate front
set arrow 1 from 1.22, 0.85, 0.0 to 0.8425, 0.85, 0.0 head ls 1 filled size 0.12,20 front
set arrow 2 from 3.55, 0.85, 0.0 to 3.95, 0.85, 0.0 head ls 1 filled size 0.12,20 front
...
'NORD_Short_Period_3_short.txt' using 1:7:8 notitle with filledcurve fs solid 0.08 noborder fillcolor "blue", \
'NORD_Short_Period_3_short.txt' using 2:7:8 notitle with filledcurve fs solid 0.08 noborder fillcolor "blue", \
